...
if __name__ == '__main__':
    ...
    ================================================================================
        ...
        print(f'Sorry; Cello was not able to complete your request.\n'  # TODO: Add FAQ or other supporting documents?
              f'Please see the error code below, and for more info, check the repository README...\n'
              f'{e}')
